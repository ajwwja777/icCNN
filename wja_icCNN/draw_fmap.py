...
import h5py
import argparse
#python draw_fmap.py -model vgg -folder_name 16_vgg_cub_iccnn_e-6 -fmap_path ../data/iccnn/basic_fmap/vgg/13_vgg_bird_ori.npz -loss_path ../data/iccnn/vgg/13_vgg_bird_ori/loss.npz
# python draw_fmap.py \
#        -model 13_vgg -animal bird \
#        -folder_name 13_vgg_bird_iccnn_m2 \
#        -fmap_path ../data/iccnn/basic_fmap/vgg_download_m2/13_vgg_bird_iccnn.npz \
#        -loss_path ../data/iccnn/vgg_download/13_vgg_bird_iccnn/loss_2500.npz

# python draw_fmap.py -model 13_vgg -animal bird -folder_name 13_vgg_bird_iccnn_m2 -fmap_path ../data/iccnn/basic_fmap/vgg_download_m2/13_vgg_bird_iccnn.npz -loss_path ../data/iccnn/vgg_download/13_vgg_bird_iccnn/loss_2500.npz

# python draw_fmap.py -model 13_vgg -animal bird -folder_name 13_vgg_bird_iccnn -fmap_path ../data/iccnn/basic_fmap/vgg_download/13_vgg_bird_iccnn.npz -loss_path ../data/iccnn/vgg_download/13_vgg_bird_iccnn/loss_2500.npz
...
# parser.add_argument('-animal', type=str, default="bird")
# parser.add_argument('-fmap_path', type=str)
# parser.add_argument('-loss_path', type=str)#used to choose filters
...
def image_add_mask(show_num,image_dir,mask_dir,save_dir,save_channel,factor,animal,show_num_per_center):
    for i in show_num:
        if animal == 'bird':
            ...
            image_paths = image_dir + str(i+3) + '.jpg'
            # image_paths = image_dir + 'bird1770_2008_004027' + '.jpg'
        else:
...
if __name__ == '__main__':
    ...
    save_dir='../data/iccnn/fmap/'+model_name+'/'+animal+'/'
    #
    if os.path.exists(save_dir):
        shutil.rmtree(save_dir)
        os.makedirs(save_dir)
    ...
    if args.animal == 'cub':
        ...
        # img_dir =  '../Data/iccnn/testing_images_for_visualization/voc'+animal+'_test/'
        img_dir =  '../Data/iccnn/dataset/voc2010_crop/my_bird/'
    mask_dir = '../data/iccnn/fmap/'+model_name+'/'+animal+'/'   # i.e. the dir of feature maps (same with the 'save_dir' above)
    masked_save_dir = '../data/iccnn/fmap/'+model_name+'/'+animal+'_masked/' # save dir of images with the red circle we want!
